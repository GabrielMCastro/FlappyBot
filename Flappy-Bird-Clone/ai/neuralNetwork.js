 ...
 */
const { complex, multiply } = math


const NeuralNetwork = function (genes, bias, activation, outputActivation, id, getGlobalInfo) 
{
    let score = 0
    let genome = genes
    let networkMatrix
    ...
    function execute(inputs) {
        ...
        passes = 0; // TODO: Look into detecting cycles and removing them
